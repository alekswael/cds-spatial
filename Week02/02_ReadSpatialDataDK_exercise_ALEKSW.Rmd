...
1. How many features does each layer contain and what kind of geometry are they?
  - Forests contains 32 polygons, parks contains 47 polygons, playgrounds contains 51 points and shelters contains 19 points.

2. What is the CRS value in these objects?
  - ETRS89 / UTM zone 32N for all variables
...
* Use the `nrow()` function on yourles exist in your new data frame. Does the data frame only have the `navn` and `areal_m new object to determine how many parks greater than 5ha are in the dataset.
...
* Use the `head()` function to check which variab2` columns (the answer is no, why)?
...
<<<<<<< HEAD:Week02/02_ReadSpatialDataDK_exercise_ALEKSW.Rmd
<<<<<<< HEAD:Week02/02_ReadSpatialDataDK_exercise.Rmd
=======
<<<<<<< HEAD:Week02/02_ReadSpatialDataDK_exercise_ALEKSW.Rmd
nlayers(elevation)
nlayers(aarhus)
=======
>>>>>>> 655c125e0c6542a5b8fb9c376d408ce94ec4930a:Week02/02_ReadSpatialDataDK_exercise.Rmd
nlayers(___)
nlayers(___)
...
nlayers(elevation)
nlayers(aarhus)
>>>>>>> 906fa6e (week 2 exercise finished):Week02/02_ReadSpatialDataDK_exercise_ALEKSW.Rmd
=======
>>>>>>> 8d1e0cbfdf86d22c0bd644badd3b87b7c191eba4:Week02/02_ReadSpatialDataDK_exercise.Rmd
>>>>>>> 655c125e0c6542a5b8fb9c376d408ce94ec4930a:Week02/02_ReadSpatialDataDK_exercise.Rmd
```
...
```{r}
print(elevation) # 396 rows, 876 cols, which is 346896 cells
print(aarhus) # 3334 rows, 3334 cols, which is 11115556 cells
```
...
=======
  - It has 5 color bands? I don't get it.
